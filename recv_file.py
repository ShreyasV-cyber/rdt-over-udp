...
from rdt.constants import DEFAULT_RECEIVER_PORT, DEFAULT_WINDOW
from rdt.receiver import (
    GoBackNReceiver,
...
def main(argv=None):
    ...
    p.add_argument("--window", type=int, default=DEFAULT_WINDOW,
                   help=f"window size, sr only (default: {DEFAULT_WINDOW})")
    ...
    receiver = PROTOCOLS[args.protocol](**kwargs)
